...
const BookAppointmentPage = ({ translateId, storeId, setIsModalOpen,storeTypes,domain }) => {
    ...
    <>
     <div className="container">
      <div className="book-appointment">
        ...
        <h2 className="text-center mb-3"><FormattedMessage id="common.bookApp" /></h2>
        }
        {storeTypes[domain] === "df" &&
        <h1 className="text-center mb-3"><FormattedMessage id="common.bookApp"/></h1>
        }
                          ...
                          return (
                            ...
                            >
                              <CustomCard
                                ...
                                activeClass={`${
                                  isCardActive === ele.id ? "select-card" : ""
                                }`}
                              />
                            </div>
                          );
        ...
        <div
          className="btn-actions mt-30 d-flex mb-30"
          style={{
        ...
        >
          {appointmentStep !== 5 && (
            <Button
              ...
              className={`previous-button ${storeTypes[domain] === "df" ? "brown-color-outlined" : ""}`}
            >
              Previous
            </Button>
          )}
          {appointmentStep < 5 && (
            <Button
              ...
              className={`next-button ${storeTypes[domain] === "df" ? "brown-color-outlined" : ""}`}
              disabled={
                loading ||
