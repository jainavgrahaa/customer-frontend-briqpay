        ...
        <div className={`filters-mobile ${showMobileFilters ? "sticky-top" : "sticky-bottom"}`}>
          ...
          >
            ...
            <div className="mobile-filter-actions">
              ...
              <button className="standard-btn btn-link"><FormattedMessage id="dfList.ResetAll"/>l</button>
            </div>
          </div>
        </div>

        <div className="product-thumb row">
          {WeddingRingListingData.map((product, index) => {
            return (
              <div
...
export default WeddingRingList;
