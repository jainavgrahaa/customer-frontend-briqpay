...
const NeckLaceRingList = ({ pageName }) => {
    ...
    <>
      <div className="product-listing">
        ...
        <div className={`filters-mobile ${showMobileFilters ? "sticky-top" : "sticky-bottom"}`}>
          ...
          >
            <span className="title"><FormattedMessage id="dfList.Filters"/></span>
          ...
          >
            ...
            <div className="mobile-filter-actions">
              <button className="btn-link-primary"><FormattedMessage id="dfList.selectFilter"/></button>
              <button className="standard-btn btn-link"><FormattedMessage id="dfList.ResetAll"/></button>
            </div>
          </div>
        </div>

        <div className="product-thumb row">
          {NeckLaceListingData.map((product, index) => {
            return (
              <div
              ...
              >
                    ...
                    <p className="bestseller"><FormattedMessage id="subHeadTabs.bestseller"/></p>
                  ) : null}
                ...
                <Link href="/product-details">
                  ...
                  {product.details && (
                    <p>
                      <span className="price-from"><FormattedMessage id="dfProduct.from"/> </span>
        ...
        <div className="view-more">
          <button className="view-more-btn btn-link-primary"><FormattedMessage id="dfList.ViewMore"/></button>
        </div>
      </div>
    </>
  );
...
export default NeckLaceRingList;
